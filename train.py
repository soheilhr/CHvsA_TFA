...
def data_preprocess(path_dataset='/data/datasets/external/', sub_folders=['Fast','Slow','SlowPocket'],save=True):
    dat_all=[]
    des_all=[]
...
path='/media/soheil/Data/mmWave_data/external/adc_Data_reshaped.mat'
dat_path='/data/datasets/external/dat_merged.npy'
des_path='/data/datasets/external/des_merged.csv'
...
pd.crosstab(y_pred_class,y_test)
